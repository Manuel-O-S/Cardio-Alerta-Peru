...
export const HOSPITALES = {
  ...
  lima: [
    ...
    {
      id: "hosp-agurto-chosica",
      nombre: "Hospital José Agurto Tello de Chosica",
      nivel: "Nivel II-2",
      iafas: "MINSA / SIS",
      profesionales: { disponibles: 3, total: 4 },
      examenes: { ecocardiograma: true, ecografia: true, radiografiaTorax: true },
      direccion: "Jr. Arequipa 214-218, Chosica, Lurigancho",
      contacto: "(01) 418-3232",
      lat: -11.9400,
      lon: -76.7020,
    },
    {
      id: "hosp-pnp-leguia",
      nombre: "Hospital PNP Augusto B. Leguía",
      nivel: "Nivel II-1",
      iafas: "MINSA / SIS",
      profesionales: { disponibles: 3, total: 3 },
      examenes: { ecocardiograma: true, ecografia: true, radiografiaTorax: true },
      direccion: "Psje. San Germán s/n cdra. 2, Urb. Villacampa, Rímac",
      contacto: "(01) 483-2851",
      lat: -12.0282,
      lon: -77.0194,
    },
    {
